...
//@Listeners(ExtentReportListener.class) //Add this line if you want run this class individually and generate report
...
public class LoginPageTest extends BaseTest {
	...
	@Test
	@Description("verify forgot p wd link test...")
